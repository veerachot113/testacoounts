# Generated by Django 5.0.2 on 2024-08-23 12:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0014_remove_user_line_user_id'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('นาย', 'นาย'), ('นาง', 'นาง'), ('นางสาว', 'นางสาว')], default='0', max_length=10)),
                ('faculty', models.CharField(choices=[('วิทยาศาสตร์', 'วิทยาศาสตร์'), ('คณะเกษตรศาสตร์', 'คณะเกษตรศาสตร์'), ('คณะวิศวกรรมศาสตร์', 'คณะวิศวกรรมศาสตร์'), ('คณะศิลปศาสตร์', 'คณะศิลปศาสตร์'), ('คณะเภสัชศาสตร์', 'คณะเภสัชศาสตร์'), ('คณะบริหารศาสตร์', 'คณะบริหารศาสตร์'), ('วิทยาลัยแพทยศาสตร์และการสาธารณสุข', 'วิทยาลัยแพทยศาสตร์และการสาธารณสุข'), ('คณะนิติศาสตร์', 'คณะนิติศาสตร์'), ('คณะรัฐศาสตร์', 'คณะรัฐศาสตร์'), ('คณะพยาบาลศาสตร์', 'คณะพยาบาลศาสตร์')], default='0', max_length=100)),
                ('number_of_credits_required', models.IntegerField(default=0)),
                ('number_of_credits_available', models.IntegerField(default=0)),
                ('scholarship_type', models.CharField(choices=[('กยศ', 'กยศ'), ('ทุน', 'ทุน'), ('ทุน-กยศ', 'ทุน-กยศ')], default='0', max_length=50)),
            ],
        ),
    ]
